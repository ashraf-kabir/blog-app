            ...
            <div class="info">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="heading text-center">
                        ...
                        <p class="heading-text">I am an enthusiastic, self-motivated, reliable, responsible and hard working person.
                        Moreover, I am a mature team worker and adaptable to all challenging situations.
                        Besides, I am able to work well both in a team environment as well as using own initiative.
                        Furthermore, I am able to work well under pressure and adhere to strict deadlines
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                    <div class="contacts-item">
                        ...
                        <div class="content">
                            ...
                            <p class="sub-title">Kalyanpur, Main Road</p>
                        </div>
                    </div>
                </div>
            </div>
