                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{ $fiction->name }}</h4>
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            ...
                            @foreach ($fiction->posts()->orderBy('created_at', 'desc')->take(3)->get() as $post)
                ...
                <div class="offers">
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            ...
                            @foreach ($science->posts()->orderBy('created_at', 'desc')->take(3)->get() as $post)
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="case-item">
                                        <div class="case-item__thumb">
                                            <img src="{{ $post->featured }}" alt="{{ $post->title }}">
